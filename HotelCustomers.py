...
# Load data
data_path = "Data/HotelCustomers/HotelCustomers.csv"
...
"""
output :
    Shape of the original dataset: (83590, 31)
    Shape of the original dataset after preprocessing: (79811, 221)
    Optimal number of clusters: 2
    Top features: ['DaysSinceFirstStay', 'DaysSinceLastStay', 'DaysSinceCreation', 'LodgingRevenue', 'PersonsNights', 'RoomNights']
    Shape of the reduced dataset: (79811, 6)
    

    KMeans Clustering Evaluation
    Original Dataset: Silhouette Score: 0.06319911084697886, DBI: 3.007254564561011, CHI: 887.0044825120015, k: 3
    Reduced Dataset: Silhouette Score: 0.4395593809214518, DBI: 1.0251606584141915, CHI: 57793.06001651821, k: 3
    Reduced Dataset with Synthetic Data: Silhouette Score: 0.4381045636706512, DBI: 1.028165429796439, CHI: 116721.49649220341, k: 3
"""