...
# Load data
data_path = "Data/ECommerceDatasetChurn/ECommerceDatasetChurn.csv"
...
"""
output :
    Shape of the original dataset: (5630, 20)
    Shape of the original dataset after preprocessing: (3774, 29)
    Optimal number of clusters: 2
    Top features: ['CashbackAmount', 'PreferedOrderCat_Mobile Phone', 'PreferredLoginDevice_Phone', 'PreferedOrderCat_Others', 'OrderCount', 'PreferedOrderCat_Laptop & Accessory', 'Tenure', 'PreferredLoginDevice_Mobile Phone', 'DaySinceLastOrder']
    Shape of the reduced dataset: (3774, 9)
    
                                         Chi-Square Statistic   p-value
    CashbackAmount                                8664.044282  0.716043
    PreferedOrderCat_Mobile Phone                    0.538181  0.463188
    PreferredLoginDevice_Phone                       0.308203  0.578785
    PreferedOrderCat_Others                          2.834807  0.092242
    OrderCount                                     223.953695  0.507162
    PreferedOrderCat_Laptop & Accessory              2.388503  0.122231
    Tenure                                        1079.169875  0.303273
    PreferredLoginDevice_Mobile Phone                0.120965  0.727990
    DaySinceLastOrder                              343.405619  0.997442
    
    KMeans Clustering Evaluation
    Original Dataset: Silhouette Score: 0.09223574957441462, DBI: 3.0211278620200135, CHI: 355.89803445167826, k: 2
    Reduced Dataset: Silhouette Score: 0.2755016547600845, DBI: 1.3525937646028072, CHI: 910.8962679133011, k: 3
    Reduced Dataset with Synthetic Data: Silhouette Score: 0.2599909338372139, DBI: 1.635545510467554, CHI: 4249.054689284082, k: 2
    
    DBSCAN Clustering Evaluation
    Original Dataset: Silhouette Score: -0.061533662072806826, DBI: 1.1907347582530514, CHI: 2.206029407165507, eps: 0.6, min_samples: 3
    Reduced Dataset: Silhouette Score: 0.25308638110623305, DBI: 1.657444513743142, CHI: 326.84125430294563, eps: 1.0, min_samples: 15
    Reduced Dataset with Synthetic Data: Silhouette Score: 0.26755286774671044, DBI: 1.9087899854157817, CHI: 1418.437855046155, eps: 1.0, min_samples: 15
"""